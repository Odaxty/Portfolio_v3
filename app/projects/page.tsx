  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-white p-8">
      ...
      <div className="max-w-6xl mx-auto mb-8 flex items-center justify-between">
        ...
        <Link 
          href="/" 
          className="px-4 py-2 rounded-full bg-neutral-800 hover:bg-neutral-700 transition-colors text-sm"
        >
          ← Retour à l'accueil
        </Link>
      </div>
          ...
          <Card className="group h-[300px] flex flex-col justify-end p-0 overflow-hidden cursor-pointer border border-neutral-800 hover:border-green-500/50 transition-all">
            ...
            <div className="absolute inset-0 bg-neutral-900">
                {project.listecapture && project.listecapture.length > 0 ? (
                   ...
                   <div className="h-full w-full bg-neutral-800 flex items-center justify-center text-gray-700">
                      Pas d'image
                   </div>
                )}
            </div>
            ...
            <div className="relative z-10 p-6 bg-gradient-to-t from-black via-black/80 to-transparent w-full">
              ...
              <div className="flex flex-wrap gap-2">
                {project.tech.map((t) => (
                  <span key={t} className="text-[10px] bg-white/10 px-2 py-1 rounded text-white/80">
                    {t}
                  </span>
                ))}
              </div>
